...
subroutine s1()
  ...
  do ivar = 1,20
    print *, "hello"
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'ivar'
    ivar = 99
  end do
...
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'ivar'
  ...
  ! Redefinition via use in SIZE specifier (section 19.6.5, case (9))
  do concurrent (ivar = 1:10)
!ERROR: [[@LINE+2]]:{{[0-9]+}}:{{.*}}error: ADVANCE specifier is not allowed in DO CONCURRENT
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'ivar'
    read (3, '(a3)', advance='no', size = ivar) key
    print *, "hello"
  end do
...
subroutine s7()
  ...
  do iostatVar = 1,20
    print *, "hello"
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'iostatvar'
    inquire(3, iostat=iostatVar, nextrec=nextrecVar, number=numberVar, & 
      pos=posVar, recl=reclVar, size=sizeVar)
  end do
...
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'iostatvar'
  ...
  do nextrecVar = 1,20
    print *, "hello"
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'nextrecvar'
    inquire(3, iostat=iostatVar, nextrec=nextrecVar, number=numberVar, & 
      pos=posVar, recl=reclVar, size=sizeVar)
  end do
...
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'nextrecvar'
  ...
  do numberVar = 1,20
    print *, "hello"
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'numbervar'
    inquire(3, iostat=iostatVar, nextrec=nextrecVar, number=numberVar, & 
      pos=posVar, recl=reclVar, size=sizeVar)
  end do
...
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'numbervar'
  ...
  do reclVar = 1,20
    print *, "hello"
    inquire(3, iostat=iostatVar, nextrec=nextrecVar, number=numberVar, & 
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'reclvar'
      pos=posVar, recl=reclVar, size=sizeVar)
  end do
...
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'reclvar'
  ...
  do posVar = 1,20
    print *, "hello"
    inquire(3, iostat=iostatVar, nextrec=nextrecVar, number=numberVar, & 
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'posvar'
      pos=posVar, recl=reclVar, size=sizeVar)
  end do
...
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'posvar'
  ...
  do sizeVar = 1,20
    print *, "hello"
    inquire(3, iostat=iostatVar, nextrec=nextrecVar, number=numberVar, & 
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Cannot redefine DO variable 'sizevar'
      pos=posVar, recl=reclVar, size=sizeVar)
  end do
