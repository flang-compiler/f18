...
!ERROR: [[@LINE+4]]:{{[0-9]+}}:{{.*}}error: Deallocation of a polymorphic entity caused by block exit not allowed in DO CONCURRENT
!ERROR: [[@LINE+3]]:{{[0-9]+}}:{{.*}}error: Deallocation of a polymorphic entity caused by block exit not allowed in DO CONCURRENT
!ERROR: [[@LINE+2]]:{{[0-9]+}}:{{.*}}error: Deallocation of a polymorphic entity caused by block exit not allowed in DO CONCURRENT
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Deallocation of a polymorphic entity caused by block exit not allowed in DO CONCURRENT
      end block
    end do
  end block
...
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Deallocation of a polymorphic entity caused by assignment not allowed in DO CONCURRENT
    localVar = localVar1
...
!ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: Deallocation of a polymorphic entity not allowed in DO CONCURRENT
    deallocate(polyVar)
