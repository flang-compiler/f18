...
submodule (m1) ma_submodule
  ...
  !ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: 'ma_create_new_fun' was not declared a separate module procedure
...
submodule (m2) mb_submodule
  ...
  !ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: 'mb_create_new_sub' was not declared a separate module procedure
...
submodule (m3) mc_submodule
  contains
  !ERROR: [[@LINE+1]]:{{[0-9]+}}:{{.*}}error: 'mc_create' was not declared a separate module procedure
