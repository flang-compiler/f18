...
#define FLANG_PARSER_PROVIDE_TYPE_NAME(TYPE, NAME) \
  template<> inline std::string GetParserNodeName_base<TYPE>() { return NAME; }
...
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::format::ControlEditDesc::Kind, "ControlEditDesc::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(Fortran::format::IntrinsicTypeDataEditDesc::Kind,
    "IntrinsicTypeDataEditDesc::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::AccessSpec::Kind, "AccessSpec::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::BindEntity::Kind, "BindEntity::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::ConnectSpec::CharExpr::Kind, "ConnectSpec::CharExpr::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(
...
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::InquireSpec::CharVar::Kind, "InquireSpec::CharVar::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::InquireSpec::IntVar::Kind, "InquireSpec::IntVar::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::InquireSpec::LogVar::Kind, "InquireSpec::LogVar::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::IntentSpec::Intent, "IntentSpec::Intent")
FLANG_PARSER_PROVIDE_TYPE_NAME(Fortran::parser::IoControlSpec::CharExpr::Kind,
    "IoControlSpec::CharExpr::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::ProcedureStmt::Kind, "ProcedureStmt::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::SavedEntity::Kind, "SavedEntity::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(Fortran::parser::Sign, "Sign")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::StopStmt::Kind, "StopStmt::Kind")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::TypeParamDefStmt::KindOrLen, "TypeParamDefStmt::KindOrLen")
FLANG_PARSER_PROVIDE_TYPE_NAME(
    Fortran::parser::UseStmt::ModuleNature, "UseStmt::ModuleNature")
FLANG_PARSER_PROVIDE_TYPE_NAME(
