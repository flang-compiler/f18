...
ENUM_CLASS(OmpClause, ALIGNED, COLLAPSE, COPYIN, COPYPRIVATE, DEFAULT,
    ...
    ORDERED, PRIORITY, PRIVATE, PROC_BIND, REDUCTION, SAFELEN, SCHEDULE, SEQ_CST, 
    SHARED, SIMD, SIMDLEN, THREAD_LIMIT, THREADS, TO, UNIFORM, UNTIED, 
    USE_DEVICE_PTR)
...
public:
  ...
  void Enter(const parser::OmpMemoryClause &);
