...
#define NODE(T1, T2) NODE_NAME(T1::T2, #T2)
  ...
  NODE(parser, OpenMPDoConstruct)
  NODE(parser, OmpEndDo)
  NODE(parser, OpenMPDoSimdConstruct)
  ...
  NODE(parser, OmpDeclarativeDirective)
  NODE(parser, OmpDeclareReduction)
  NODE(parser, OmpReductionInitializerClause)
  NODE(parser, OmpReductionCombiner)
  NODE(parser::OmpReductionCombiner, FunctionCombiner)
  NODE(parser::OmpDeclarativeDirective, DeclareSimd)
  NODE(parser, OmpDeclareTargetMapType)
  NODE(parser::OmpDeclareTargetMapType, Type)
  NODE(parser, OmpDeclareTarget)
  NODE(parser::OmpDeclareTarget, Implicit)
  NODE(parser::OmpDeclareTarget, WithClause)
  NODE(parser::OmpDeclareTarget, WithExtendedList)
  NODE(parser::OmpDeclarativeDirective, Threadprivate)
